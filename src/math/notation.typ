...
// distinguish the real transpose from the conjugate one. Physics spells the
// conjugate transpose with the builtin dagger, and a document commits to one
// of the two spellings and never alternates.
#let transp = sym.top
